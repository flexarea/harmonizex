...
export default function PictureChoose() {
  const [, setSelectedImages] = useState([]); // can hold the images
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Please choose some pictures and/or videos for your account."
        />
      </Head>
      <main className={styles.main}>
        <div className={styles.center} style={{ flexDirection: "column" }}>
          <Image
            src="/../../ourImages/profpic3.jpg"
          ...
          <div className={styles.center} style={{ margin: "20px 0" }}>
            ...
            <div>
              ...
              <input
                type="file"
                accept="image/*"
                onChange={choosingImage}
                multiple
              />
            </div>
          </div>
          <Image
            src="/../../ourImages/grid1.png"
            alt="Profile Videos"
            width={400}
            height={350}
            priority
